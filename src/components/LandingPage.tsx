          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 rounded-lg border p-0.5" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-surface)' }}>
              <button
                ...
                className={`rounded-md p-1.5 transition-all ${effective === 'dark' ? 'text-emerald-400 shadow-sm' : ''}`}
                style={{ 
              ...
              <button
                ...
                className={`rounded-md p-1.5 transition-all ${effective === 'light' ? 'text-emerald-400 shadow-sm' : ''}`}
                style={{ 
              ...
              <button
                ...
                className={`rounded-md p-1.5 transition-all ${theme === 'system' ? 'text-emerald-400 shadow-sm' : ''}`}
                style={{ 
